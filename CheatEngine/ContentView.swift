        ...
        NavigationView {
            VStack {
                ...
                if procVM.selectedPID != -1 {
                    ...
                    .disabled(scanner.attach(to: procVM.selectedPID) == false)
                }
                ...
                List {
                    ForEach(scanner.results) { item in
                        ...
                        .onTapGesture {
                            // Cho phép sửa giá trị trực tiếp
                            editValueText = "\(item.value)"
                            // Lưu địa chỉ để chỉnh sửa
                ...
                HStack {
                    ...
                    Button("Ghi") {
                        ...
                        if mode == "int32", let v = Int32(editValueText) {
                            ...
                            // Ghi chuỗi chưa hỗ trợ trong demo này (cần viết thêm)
